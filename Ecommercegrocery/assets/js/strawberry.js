...
if (productId && productId !== 'strawberry-001') {
   
    alert(`You searched for product ID: ${productId}. This page currently only supports Strawberry.`);
}
